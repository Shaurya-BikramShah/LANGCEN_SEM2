        ...
        <div class="main-content">
            ...
            <div class="form-container">
                ...
                <form action="${pageContext.request.contextPath}/admin-dashboard" method="post">
                    <input type="text" name="fullName" placeholder="Full Name" value="${studentToUpdate.name}" required>
                    ...
                    <input type="text" name="course" placeholder="Course" value="${studentToUpdate.course}" required>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="${pageContext.request.contextPath}/admin-dashboard" method="post" class="action-form">
                                        ...
                                        <input type="hidden" name="fullName" value="${student.name}">
